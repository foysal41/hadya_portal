...
export const newsCards = [
  {
    ...
    title: "Saudi Arabia Extends Umrah Visa Validity to 90 Days",
    description:
...

  {
    ...
    title:
      "Record 11.9 Million Pilgrims Complete Hajj 2025",
    description:
            ...
            {newsCards.map((news) => {
              return <div key={news.id} className='' >
                ...
                <div className='px-5 py-10 flex flex-col gap-5 bg-white'>
                  ...
                  <Link href={"#"}> <h3 className={`${style.heading.h3} hover:text-primary  `}  >{news.title.length > 60 ? news.title.slice(0, 60) + "..." : news.title} </h3>  </Link>
                  <p>{news.date}</p>
